...
final class NewGameViewController: ScreenViewController<NewGameScreen> {
    let playerXLabel: UILabel = UILabel(frame: .zero)
    let playerXField: UITextField = UITextField(frame: .zero)
    let playerOLabel: UILabel = UILabel(frame: .zero)
    let playerOField: UITextField = UITextField(frame: .zero)
    let startGameButton: UIButton = UIButton(frame: .zero)
